...
def test_lock_ibc_coins(
    ...
    logging.info("this test of locking an ibc token relies on the smart contracts deploying a destination ERC20 contract")
    ...
    request.ethereum_symbol = feedface_token
    request.amount = small_amount
